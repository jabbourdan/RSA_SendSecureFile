...
std::string EncryptionHandler::getPrivateKey() const
{
...
std::string EncryptionHandler::getPublicKey() const
{
...
std::string EncryptionHandler::decryptAESKeyPrivateRSAKey(const std::string& encrypted_aes_key, const std::string& private_RSA)
{
	...
	CryptoPP::RSA::PrivateKey private_key = stringToPrivateKey(private_RSA);
...
CryptoPP::RSA::PrivateKey EncryptionHandler::stringToPrivateKey(const std::string& private_key_str) {
...
std::string EncryptionHandler::privateKeyToString(const CryptoPP::RSA::PrivateKey& private_key)
{
