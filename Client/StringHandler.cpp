...
std::string StringHandler::serializeRequest(const Request& request) {
...
int StringHandler::stringToInt(const std::string& str)
{
    try
    {
...
std::vector<std::string> StringHandler::splitString(std::string str, char delimiter)
{
