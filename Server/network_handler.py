...
KEYS_EXCHANGE_REQUEST = 1026
RECONNECT_REQUEST = 1027
FILE_TRANSFER_REQUEST = 1028
VALID_CKSUM_FINISH_REQUEST = 1029
INVALID_CKSUM_RESEND_REQUEST = 1030
INVALID_CKSUM_FINISH_REQUEST = 1031
...
class NetworkHandler:
    ...
    def handle_invalid_cksum_request(self, request_parameters):
        self.database_handler.update_crc(self.client_id, False)
        # request 1028 (FILE_TRANSFER_REQUEST) is about to be resent
